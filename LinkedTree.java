...
public class LinkedTree {
    ...
    public static int numOccurences(Node root, int item) {
    	
    	if (root.left == null && root.right == null && root.key == item) {
    		return 1;
    	} else if ((root.left == null && root.right == null && root.key != item) || root == null) {
    		return 0;
    	} else if (root.left == null && root.right != null) {
    		return numOccurences(root.right,item);
    	} else if ( root.left != null && root.right == null) {
    		return numOccurences(root.left,item); 
    	}	else {
    	}
    		return numOccurences(root.left,item) + numOccurences(root.right,item);
    	}
    ...
    private class PostorderIterator implements LinkedTreeIterator {
    	private Node nextNode;
    	 ...
    	 private PostorderIterator() {
             // The traversal starts with the first leaf node.
    		 Node trav = root;
    		 Node parent = null;
    ...
    public static void main(String[] args) {
    	...
    	System.out.println("Testing PostorderIterator "); 
    	System.out.println("------------------------- "); 
    	...
    	int[] keys = {37, 26, 42, 13, 35, 13, 56, 47, 70};
    	...
    	System.out.println();
    	System.out.println(numOccurences(tree2.root, 13));
