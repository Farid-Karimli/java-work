...
public class StringNode {
    ...
    public static StringNode copy(StringNode str) {
    	...
    	StringNode trav = str;
    	StringNode trav_copy = copy;
    	
    	
    	while (trav.next != null) {
    		
    		trav_copy.next = new StringNode(trav.next.ch, null);
    		
    		trav_copy = trav_copy.next;
    		trav = trav.next;
    	}
                                         ...
                                         char afterChar) 
    {
    	...
    	if (str == null) {
    		...
    		StringNode new_char = new StringNode(newChar, str.next);
    		str.next = new_char;
    		...
    		StringNode next = insertAfter(str.next, newChar, afterChar);
    		
    		if (next == null) {
    			
    			str.next = new StringNode(newChar, null);
    		}
    ...
    public static boolean isPrefix(StringNode prefix, StringNode str) {
        // Three base cases.
        StringNode trav_prefix = prefix;
        StringNode trav_str = str;
        ...
        while (trav_prefix != null) {
        	
        	if (trav_prefix.ch != trav_str.ch) {
        		
        		return false;
        		
        	}
        	
        	trav_prefix = trav_prefix.next;
        	trav_str = trav_str.next;
